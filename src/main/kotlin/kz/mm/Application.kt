...
import kz.mm.client.movieService.MovieServiceRestClient
...
fun Application.module() {
    ...
    val movieService = MovieServiceRestClient()
    val activityGraphRepo = ActivityGraphRepository(neo4jConfig.driver)
    val recService = DefaultRecommendationService(
        Neo4jJAlgorithmRecommendationService(repo, movieService, activityGraphRepo),
        movieService
    )
